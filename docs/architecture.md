...
flowchart TD
    ...
    subgraph Persistence ["Persistence Ledger (src/persistence)"]
        TimerStop --> RunRec["Build RunRecord (22 standardized fields)"]
...
[Engine Execution Completed]
       ...
       │        • 22 standardized, self-documenting columns
       ...
       └───> 4. Cloud Webhook Dispatch (Optional: Google Sheets)
                • Asynchronous HTTP POST transmitting 22 metrics in real time
